...
import { revokeMfaCredentials, clearMfaSession } from '@/utils/mfa/db/utils'
...
export async function GET(req: NextRequest) {
  console.log('/api/mfa/revokeKeys: GET ')
  // Get Session
  ...
  // Clear MFA Sessions
  const mfaCleared = await clearMfaSession(user.address)
  // Revoke user keys
